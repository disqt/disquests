...
class DirtyDetectionJourney {
  ...
  void clickNoReturnsToEdit(ClientGameTestContext context) {
    ...
    boolean isEditing =
        context.computeOnClient(c -> c.gui.screen() instanceof QuestScreen qs && qs.isEditing());
    ...
    assertEquals(
        "Modified", titleText, "Title field should still contain 'Modified' after clicking No");
  }
