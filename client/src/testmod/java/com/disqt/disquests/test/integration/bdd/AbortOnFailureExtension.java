...
/**
 * Skips remaining @Order steps in a journey if a prior step failed. Prevents cascading failures
...
public class AbortOnFailureExtension implements ExecutionCondition, AfterTestExecutionCallback {
  ...
  public void afterTestExecution(ExtensionContext context) {
    context
        ...
        .ifPresent(ex -> context.getTestClass().ifPresent(cls -> FAILURES.putIfAbsent(cls, ex)));
  }
