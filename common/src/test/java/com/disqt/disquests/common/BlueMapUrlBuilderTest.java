...
class BlueMapUrlBuilderTest {
  ...
  void testBlueMapUrl_withMapping() {
    ...
    String url =
        BlueMapUrlBuilder.buildUrl(
            "https://disqt.com/minecraft/map", 100.0, 64.0, -200.0, "overworld", mapNames);
    assertEquals(
  ...
  void testBlueMapUrl_unknownMapFallback() {
    ...
    String url =
        BlueMapUrlBuilder.buildUrl("https://example.com", 0, 0, 0, "custom_world", mapNames);
  ...
  void testBlueMapUrl_regionCenter() {
    ...
    String url =
        BlueMapUrlBuilder.buildUrlRegion(
            "https://example.com", -1688, 57, 168, -1688, 57, 296, "overworld", mapNames);
  ...
  void testBlueMapUrl_nullMapDefaultsToWorld() {
    String url = BlueMapUrlBuilder.buildUrl("https://example.com", 10, 20, 30, null, Map.of());
  ...
  void testBlueMapUrl_baseWithoutTrailingSlash_getsSlashAdded() {
    ...
    String urlWithSlash =
        BlueMapUrlBuilder.buildUrl(
            "https://disqt.com/minecraft/map/", 50.0, 70.0, -300.0, "overworld", mapNames);
  ...
  void testBlueMapUrl_negativeCoordinates() {
    ...
    String url =
        BlueMapUrlBuilder.buildUrl(
            "https://example.com", -1234.0, -56.0, -789.0, "overworld", mapNames);
  ...
  void testBlueMapUrl_largeCoordinates() {
    ...
    String url =
        BlueMapUrlBuilder.buildUrl(
            "https://example.com", 12345.0, 128.0, -67890.0, "overworld", mapNames);
  ...
  void testBlueMapUrl_invalidSchemeReturnsNull() {
    assertNull(BlueMapUrlBuilder.buildUrl("ftp://example.com", 0, 0, 0, "world", Map.of()));
  }
  ...
  void testBlueMapUrl_hashHasExactly10Values() {
    ...
    String url =
        BlueMapUrlBuilder.buildUrl(
            "https://example.com", 100.0, 64.0, -200.0, "overworld", mapNames);
    assertNotNull(url);
