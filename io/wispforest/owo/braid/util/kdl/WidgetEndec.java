...
public class WidgetEndec {
    ...
    public static <W extends Widget> void register(class_2960 key, Class<W> widgetClass, StructEndec<W> endec) {
        register(key.method_42094(), widgetClass, endec);
    }
    ...
    static {
        ...
        register(
            ...
            StructEndecBuilder.of(
                ...
                Endec.BOOLEAN.optionalFieldOf("translate", s -> s.text.method_10851() instanceof class_2588, false),
                Endec.STRING.fieldOf("@argument", s -> s.text.getString()),
                (style, softWrap, overflow, translate, text) -> new Label(
                    style,
                    softWrap,
                    overflow,
                    translate ? class_2561.method_43471(text) : class_2561.method_43470(text)
                )
            )
        );
        ...
        register(
            ...
            SpriteWidget.class,
            StructEndecBuilder.of(
                MinecraftEndecs.IDENTIFIER.fieldOf("@argument", s -> s.spriteIdentifier.method_24147()),
                MinecraftEndecs.IDENTIFIER.optionalFieldOf("atlas", s -> s.spriteIdentifier.method_24144(), SpriteWidget.GUI_ATLAS_ID),
                (id, atlas) -> new SpriteWidget(new class_4730(atlas, id))
            )
        );
        ...
        register(
            ...
            StructEndecBuilder.of(
                Endec.forEnum(class_811.class, false).optionalFieldOf("display_context", ItemStackWidget::displayContext, class_811.field_4317),
        ...
        register(
            ...
            BlockWidget.class,
            StructEndecBuilder.of(
                BraidKdlEndecs.BLOCK_STRING.fieldOf("@argument", s -> new class_2259.class_7211(s.blockState, s.blockState.method_11656(), s.blockEntityNbt)),
                blockResult -> new BlockWidget(blockResult.comp_622(), blockResult.comp_624())
            )
        );
        ...
        register(
            ...
            StructEndecBuilder.of(
                ...
                Endec.BOOLEAN.optionalFieldOf("translate_message", s -> s.text.method_10851() instanceof class_2588, () -> false),
                ...
                (message, translateMessage, handler, handlerArg) -> new MessageButton(
                    translateMessage
                        ? class_2561.method_43471(message)
