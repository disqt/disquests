...
public class KdlDeserializer extends RecursiveDeserializer<KdlElement> implements SelfDescribedDeserializer<KdlElement> {
    ...
    public <E> Deserializer.Sequence<E> sequence(SerializationContext ctx, Endec<E> elementEndec) {
        return new io.wispforest.owo.braid.util.kdl.KdlDeserializer.Sequence<>(ctx, elementEndec, expectElement(ctx, KdlElement.KdlElementList.class).elements());
    }
    ...
    public Deserializer.Struct struct(SerializationContext ctx) {
        return new io.wispforest.owo.braid.util.kdl.KdlDeserializer.Struct(expectElement(ctx, KdlElement.KdlNodeElement.class).node());
    }
