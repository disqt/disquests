...
public final class BraidKdlEndecs {
    ...
    public static final Endec<class_1799> ITEM_STACK_STRING = Endec.STRING.xmap(
        s -> {
            try {
                var result = new class_2291(class_310.method_1551().field_1687.method_30349()).method_9789(new StringReader(s));
                var stack = result.comp_628().comp_349().method_7854();
    ...
    public static final Endec<class_2259.class_7211> BLOCK_STRING = Endec.STRING.xmap(
        s -> {
            try {
                return class_2259.method_41957(class_7923.field_41175, s, true);
            } catch (CommandSyntaxException e) {
