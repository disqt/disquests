...
public class LayerContext extends StatefulWidget {
    ...
    public final BraidEventSource<class_3902> refreshEvents;
    public final class_437 contextScreen;
    public final Widget child;

    public LayerContext(BraidEventSource<class_3902> refreshEvents, class_437 contextScreen, Widget child) {
    ...
    public static class_339 findWidget(BuildContext context, Predicate<class_339> predicate) {
        var layerContext = of(context);

        var widgets = new ArrayList<class_339>();
        for (var element : layerContext.contextScreen.method_25396()) {
    ...
    public static class_437 screenOf(BuildContext context) {
...
class LayerContextScope extends InheritedWidget {
    ...
    public LayerContextScope(Widget child, class_437 contextScreen) {
        super(child);
        this.contextScreen = contextScreen;
    }
