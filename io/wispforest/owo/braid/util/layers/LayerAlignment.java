...
public class LayerAlignment extends StatefulWidget {
    ...
    public static LayerAlignment atVanillaWidget(Predicate<class_339> anchorPredicate, Widget widget) {
        return atVanillaWidget(anchorPredicate, AnchorJustification.TOP_LEFT_TO_TOP_LEFT, widget);
    }

    public static LayerAlignment atVanillaWidget(Predicate<class_339> anchorPredicate, AnchorJustification justification, Widget widget) {
        return new LayerAlignment(
            context -> {
                ...
                return new Vector2d(
                    anchor.method_46426() + justification.anchorX() * anchor.method_25368(),
                    anchor.method_46427() + justification.anchorY() * anchor.method_25364()
                );
            },
            justification,
            widget
