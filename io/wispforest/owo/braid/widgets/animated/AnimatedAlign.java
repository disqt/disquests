...
public class AnimatedAlign extends AutomaticallyAnimatedWidget {
    ...
    @Override
    public io.wispforest.owo.braid.widgets.animated.AnimatedAlign.State createState() {
        return new io.wispforest.owo.braid.widgets.animated.AnimatedAlign.State();
    }
