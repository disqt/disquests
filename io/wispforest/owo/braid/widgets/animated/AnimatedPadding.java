...
public class AnimatedPadding extends AutomaticallyAnimatedWidget {
    ...
    @Override
    public io.wispforest.owo.braid.widgets.animated.AnimatedPadding.State createState() {
        return new io.wispforest.owo.braid.widgets.animated.AnimatedPadding.State();
    }
