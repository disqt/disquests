...
public class Slider extends StatefulWidget {
    ...
    public static class State extends WidgetState<Slider> {
            ...
            return new LayoutBuilder((innerContext, constraints) -> {
                ...
                return new Center(
                    widget.onChanged == null || ControlsOverride.controlsDisabled(context)
                        ...
                        : new Incrementor(
                            widget.axis,
                            increment -> this.applyValue(class_3532.method_15350(this.normalizedValue + this.incrementStep * increment, 0, 1)),
                            new MouseArea(
                                mouseArea -> mouseArea
        ...
        protected void move(Constraints constraints, double dx, double dy) {
            ...
            this.applyValue(class_3532.method_15350(this.dragValue, 0, 1));
        }
        ...
        protected double setAbsolute(Constraints constraints, double x, double y) {
            ...
            var axis = this.widget().axis;
            var newNormalizedValue = class_3532.method_15350((axis.choose(x, y) - this.handleSize / 2) / (constraints.maxFiniteOrMinOnAxis(axis) - this.handleSize), 0, 1);
