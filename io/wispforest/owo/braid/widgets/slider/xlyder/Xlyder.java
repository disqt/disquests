...
public class Xlyder extends StatefulWidget {
    ...
    public static class State extends WidgetState<Xlyder> {
            ...
            return new LayoutBuilder((innerContext, constraints) -> {
                ...
                return new Center(
                    widget.onChanged == null || ControlsOverride.controlsDisabled(context)
                        ? content
                        : new Incrementor(
                            xIncrement -> this.applyValue(class_3532.method_15350(this.normalizedValue.x() + this.incrementStep.x() * xIncrement, 0, 1), null),
                            yIncrement -> this.applyValue(null, class_3532.method_15350(this.normalizedValue.y() + this.incrementStep.y() * yIncrement, 0, 1)),
                            new MouseArea(
                                mouseArea -> mouseArea
        ...
        protected void move(Constraints constraints, double dx, double dy) {
            ...
            this.applyValue(
                class_3532.method_15350(this.dragValue.x, 0, 1),
                class_3532.method_15350(this.dragValue.y, 0, 1)
            );
        }
        ...
        protected Vector2dc setAbsolute(Constraints constraints, double x, double y) {
            ...
            var newNormalizedX = class_3532.method_15350((x - (handleSize.width() / 2)) / (constraints.maxWidth() - handleSize.width()), 0, 1);
            var newNormalizedY = class_3532.method_15350((y - (handleSize.height() / 2)) / (constraints.maxHeight() - handleSize.height()), 0, 1);
