...
class SplitPaneState extends WidgetState<SplitPane> {
    ...
    public Widget build(BuildContext context) {
        return new LayoutBuilder((innerContext, constraints) -> {
            ...
            var split = Math.floor(class_3532.method_15350(this.splitCoordinate, .1 * maxSize, .9 * maxSize));
                ...
                new Flexible(
                    new MouseArea(
                        widget -> widget
                            ...
                            .dragEndCallback(() -> {
                                this.splitCoordinate = class_3532.method_15350(this.splitCoordinate, .1 * maxSize, .9 * maxSize);
                            })
