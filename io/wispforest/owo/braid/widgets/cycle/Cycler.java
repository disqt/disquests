...
public class Cycler<T> extends StatelessWidget {
    ...
    public Widget build(BuildContext context) {
        return this.builder.build(
            ...
            this.currentIndex,
            amount -> {
                var newIndex = this.wrap ? class_3532.method_15387(this.currentIndex + amount, this.values.size()) : class_3532.method_15340(this.currentIndex + amount, 0, this.values.size() - 1);
