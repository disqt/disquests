...
public class CyclingClickable extends StatelessWidget {
    ...
    public CyclingClickable(@Nullable Cycler.CycleFunction cycle, @Nullable class_3414 clickSound, boolean skipFocusTraversal, Widget child) {
        this.cycle = cycle;
    ...
    private <I extends Intent> Action.Callback<I> cycleCallback(Cycler.CycleFunction cycle, ToIntFunction<I> offset) {
        var sound = this.clickSound != null ? this.clickSound : class_3417.field_15015.comp_349();
