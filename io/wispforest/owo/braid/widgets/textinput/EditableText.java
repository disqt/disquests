...
public class EditableText extends StatefulWidget {
    ...
    protected class_2583 baseStyle = class_2583.field_24360;
    protected class_2561 suggestion = class_2561.method_43473();
    ...
    public EditableText baseStyle(class_2583 baseStyle) {
        this.assertMutable();
        this.baseStyle = baseStyle;
        return this;
    }

    public class_2583 baseStyle() {
        return this.baseStyle;
    }

    public EditableText suggestion(class_2561 suggestion) {
        this.assertMutable();
        this.suggestion = suggestion;
        return this;
    }

    public class_2561 suggestion() {
        return this.suggestion;
    }

    public EditableText placeholder(class_2561 placeholder) {
        this.assertMutable();
    ...
    public static class State extends WidgetState<EditableText> {
        ...
        private void listenerCallback() {
            this.schedulePostLayoutCallback(() -> {
                ...
                var lineHeight = inputInstance.host().client().field_1772.field_2000;
