...
public abstract class ConstraintWidget extends SingleChildInstanceWidget {
    ...
    public static class Instance extends SingleChildWidgetInstance<ConstraintWidget> {
        ...
        protected double measureIntrinsicWidth(double height) {
            return class_3532.method_15350(this.child.getIntrinsicWidth(height), this.widget.constraints().minWidth(), this.widget.constraints().maxWidth());
        }

        @Override
        protected double measureIntrinsicHeight(double width) {
            return class_3532.method_15350(this.child.getIntrinsicHeight(width), this.widget.constraints().minHeight(), this.widget.constraints().maxHeight());
        }
