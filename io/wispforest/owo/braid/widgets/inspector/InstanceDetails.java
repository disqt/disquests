...
public class InstanceDetails extends StatefulWidget {
    ...
    public static class State extends WidgetState<InstanceDetails> {
        ...
        public Widget build(BuildContext context) {
            ...
            if (selected instanceof WidgetInstance<?> instance) {
                ...
                children.addAll(List.of(
                    ...
                    new Label(class_2561.method_43470(instanceClassName))
                ));
            } else {
                children = List.of(new Flexible(
                    new Center(
                        new Label(class_2561.method_43470("no instance selected"))
                    )
                ));
            }
            ...
            return new Row(
                ...
                new Sized(
                    ...
                    new Column(
                        Stream.concat(
                            Stream.of(new Padding(Insets.bottom(3), new Label(class_2561.method_43470("Instance Details")))),
                            children.stream()
                        ).toList()
                    )
                )
        ...
        private static List<class_2561> gatherProperties(WidgetInstance<?> instance) {
            ...
            var properties = new ArrayList<>(List.<class_2561>of(
                    class_2561.method_43470("Rel. Position").method_27692(class_124.field_1067),
                    class_2561.method_43470(rounded(instance.transform.x()) + ", " + rounded(instance.transform.y())),
                    class_2561.method_43470("Abs. Position").method_27692(class_124.field_1067),
                    class_2561.method_43470(rounded(absPos.x()) + ", " + rounded(absPos.y())),
                    class_2561.method_43470("Width").method_27692(class_124.field_1067),
                    class_2561.method_43470(instance.transform.width() + "px"),
                    class_2561.method_43470("Height").method_27692(class_124.field_1067),
                    class_2561.method_43470(instance.transform.height() + "px"),
                    class_2561.method_43470("Widget").method_27692(class_124.field_1067),
                    class_2561.method_43470(instance.widget().getClass().getSimpleName())
            ));

            for (var property : instance.debugListInspectorProperties()) {
                properties.add(property.name().method_27661().method_27692(class_124.field_1067));
