...
public class BraidInspector {
    ...
    private final BraidEventStream<class_3902> refreshEvents = new BraidEventStream<>();
    private final BraidEventStream<class_3902> pickEvents = new BraidEventStream<>();
    ...
    public BraidEventSource<class_3902> onPick() {
        return this.pickEvents.source();
    }

    public void pick() {
        this.pickEvents.sink().onEvent(class_3902.field_17274);
    }

    public BraidEventSource<class_3902> onRefresh() {
    ...
    public void refresh() {
        this.refreshEvents.sink().onEvent(class_3902.field_17274);
    }
