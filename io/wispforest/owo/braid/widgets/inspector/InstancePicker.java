...
public class InstancePicker extends StatefulWidget {
    ...
    public final BraidEventSource<class_3902> activateEvents;
    public final PickCallback pickCallback;
    public final Widget child;

    public InstancePicker(BraidEventSource<class_3902> activateEvents, PickCallback pickCallback, Widget child) {
