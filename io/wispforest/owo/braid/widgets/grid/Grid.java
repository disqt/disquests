...
public class Grid extends MultiChildInstanceWidget {
    ...
    public static class Instance extends MultiChildWidgetInstance<Grid> {
        ...
        protected void doLayout(Constraints constraints) {
            ...
            var mainAxisCells = class_3532.method_15384(this.children.size() / (double) this.widget.crossAxisCells);
        ...
        public List<InspectorProperty> debugListInspectorProperties() {
            return List.of(
                new InspectorProperty(
                    class_2561.method_43470("Main Axis"),
                    class_2561.method_43470(this.widget.mainAxis.toString())
                )
            );
        }
        ...
        protected void debugDrawVisualizers(BraidGraphics graphics) {
            ...
            for (int i = 0; i < verticalSizes.length; i++) {
                ...
                graphics.drawText(
                    class_2561.method_43470(verticalSizes[i] + "px").method_27694(style -> style.method_27704(new class_11719.class_11721(class_310.field_24211))),
            ...
            for (int i = 0; i < horizontalSizes.length; i++) {
                ...
                graphics.drawText(
                    class_2561.method_43470(horizontalSizes[i] + "px").method_27694(style -> style.method_27704(new class_11719.class_11721(class_310.field_24211))),
