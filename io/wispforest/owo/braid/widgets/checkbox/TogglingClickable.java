...
public class TogglingClickable extends StatelessWidget {
    ...
    public TogglingClickable(boolean checked, @Nullable CheckboxCallback onUpdate, @Nullable class_3414 clickSound, Widget child) {
    ...
    public TogglingClickable(boolean checked, boolean active, @Nullable class_3414 clickSound, CheckboxCallback onUpdate, Widget child) {
