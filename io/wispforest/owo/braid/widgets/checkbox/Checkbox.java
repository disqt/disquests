...
public class Checkbox extends StatelessWidget {
    ...
    public static final class_4730 SELECTED_HIGHLIGHTED_TEXTURE = new class_4730(
        SpriteWidget.GUI_ATLAS_ID,
        class_2960.method_60656("widget/checkbox_selected_highlighted")
    );

    public static final class_4730 SELECTED_TEXTURE = new class_4730(
        SpriteWidget.GUI_ATLAS_ID,
        class_2960.method_60656("widget/checkbox_selected")
    );

    public static final class_4730 HIGHLIGHTED_TEXTURE = new class_4730(
        SpriteWidget.GUI_ATLAS_ID,
        class_2960.method_60656("widget/checkbox_highlighted")
    );

    public static final class_4730 TEXTURE = new class_4730(
        SpriteWidget.GUI_ATLAS_ID,
        class_2960.method_60656("widget/checkbox")
    );
