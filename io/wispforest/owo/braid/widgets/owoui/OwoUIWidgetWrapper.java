...
public class OwoUIWidgetWrapper extends LeafInstanceWidget {
    ...
    public static class Instance extends LeafWidgetInstance<OwoUIWidgetWrapper> implements MouseListener {
        ...
        public boolean onMouseDown(double x, double y, int button, KeyModifiers modifiers) {
            return this.widget.rootComponent.onMouseDown(new class_11909(x, y, new class_11910(button, modifiers.bitMask())), false);
        }

        @Override
        public boolean onMouseUp(double x, double y, int button, KeyModifiers modifiers) {
            return this.widget.rootComponent.onMouseUp(new class_11909(x, y, new class_11910(button, modifiers.bitMask())));
        }
        ...
        public void onMouseDrag(double x, double y, double dx, double dy) {
            this.widget.rootComponent.onMouseDrag(new class_11909(x, y, new class_11910(this.dragButton, 0)), dx, dy);
        }
        ...
        public boolean onKeyDown(int keyCode, KeyModifiers modifiers) {
            return this.widget.rootComponent.onKeyPress(new class_11908(keyCode, GLFW.glfwGetKeyScancode(keyCode), modifiers.bitMask()));
        }

        public boolean onChar(int charCode, KeyModifiers modifiers) {
            return this.widget.rootComponent.onCharTyped(new class_11905(charCode, modifiers.bitMask()));
        }
        ...
        public void draw(BraidGraphics graphics) {
            ...
            this.widget.rootComponent.draw(
                ...
                mouseX,
                mouseY,
                client.method_61966().method_60637(false),
                client.method_61966().method_60636()
            );
