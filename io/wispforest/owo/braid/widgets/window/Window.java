...
public class Window extends StatefulWidget {
    ...
    public Window(boolean collapsible, class_2561 title, @Nullable Runnable onClose, @Nullable WindowController controller, Size initialSize, Size minSize, Size maxSize, Widget content) {
    ...
    public Window(boolean collapsible, class_2561 title, @Nullable Runnable onClose, @Nullable WindowController controller, Size initialSize, Widget content) {
    ...
    public static class State extends WidgetState<Window> {
                ...
                (buildContext, child) -> {
                    ...
                    if (this.widget().collapsible) {
                        titleBar.add(Interactable.primary(
                            ...
                            new Padding(
                                Insets.of(2, 0, 0, 4),
                                new Label(class_2561.method_43470(this.controller.collapsed() ? "⏶" : "⏷"))
                            )
                        ));
                    }
                    ...
                    if (this.widget().onClose != null) {
                        titleBar.add(Interactable.primary(
                            ...
                            new HoverStyledLabel(class_2561.method_43470("x"), class_2583.field_24360.method_27706(class_124.field_1061))
                        ));
                    }
        ...
        private void applySize(Size size) {
            this.controller.setSize(Size.of(
                class_3532.method_15350(size.width(), this.widget().minSize.width(), this.widget().maxSize.width()),
                class_3532.method_15350(size.height(), this.widget().minSize.height(), this.widget().maxSize.height())
            ));
        }
