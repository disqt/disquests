...
public class Clickable extends StatelessWidget {
    ...
    public final @Nullable class_3414 clickSound;
    public final Widget child;

    public Clickable(@Nullable BooleanSupplier onClick, @Nullable class_3414 clickSound, Widget child) {
    ...
    public Clickable(boolean active, BooleanSupplier onClick, @Nullable class_3414 clickSound, Widget child) {
    ...
    public Widget build(BuildContext context) {
        ...
        var effectiveSound = this.clickSound != null ? this.clickSound : class_3417.field_15015.comp_349();
