...
class ComboBoxButtons<T> extends StatelessWidget {
    ...
    public final Function<@Nullable T, class_2561> optionToName;
    public final ComboBox.SelectCallback<T> onSelect;

    public ComboBoxButtons(ListenableValue<ComboBoxButtonsState<T>> state, double width, Function<@Nullable T, class_2561> optionToName, ComboBox.SelectCallback<T> onSelect) {
        this.state = state;
        this.width = width;
    ...
    private static class HighlightableButton<T> extends StatefulWidget {
        ...
        public HighlightableButton(ComboBox.SelectCallback<T> onSelect, T option, boolean highlighted, Function<@Nullable T, class_2561> optionToName) {
            this.onSelect = onSelect;
            this.option = option;
                                ...
                                new Padding(
                                    ...
                                    new Label(
                                        new LabelStyle(Alignment.LEFT, highlighted
                                            ? Color.rgb(class_124.field_1054.method_532()) : null, null, highlighted),
                                        true,
