...
public class Label extends StatelessWidget {
    ...
    public Label(@Nullable LabelStyle style, boolean softWrap, Overflow overflow, class_2561 text) {
        this.style = style;
    ...
    public Label(@Nullable LabelStyle style, boolean softWrap, class_2561 text) {
        this(style, softWrap, Overflow.CLIP, text);
    }

    public Label(boolean softWrap, class_2561 text) {
        this(null, softWrap, text);
    }

    public Label(Overflow overflow, class_2561 text) {
    ...
    public static Label literal(String text) {
        return new Label(class_2561.method_43470(text));
    }
