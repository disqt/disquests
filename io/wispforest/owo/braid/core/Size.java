...
public record Size(double width, double height) {
    ...
    public Size constrained(Constraints constraints) {
        return new Size(
            class_3532.method_15350(this.width, constraints.minWidth(), constraints.maxWidth()),
            class_3532.method_15350(this.height, constraints.minHeight(), constraints.maxHeight())
        );
    }
}