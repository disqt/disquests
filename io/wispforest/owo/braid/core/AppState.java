...
public class AppState implements InstanceHost, ProxyHost {
    ...
    public void draw(class_332 graphics) {
        ...
        graphics.push();
        this.rootInstance().transform.transformToParent(graphics.method_51448());
        ...
        if (this.activeTooltip != null) {
            if (this.activeTooltip.components() != null) braidContext.drawTooltip(this.client.field_1772, this.activeTooltip.x(), this.activeTooltip.y(), this.activeTooltip.components());
            if (this.activeTooltip.style() != null) graphics.method_51441(this.client.field_1772, this.activeTooltip.style(), this.activeTooltip.x(), this.activeTooltip.y());
        }
...
record TooltipState(@Nullable List<class_5684> components, @Nullable class_2583 style, int x, int y) {}
