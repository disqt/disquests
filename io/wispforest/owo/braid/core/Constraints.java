...
public record Constraints(double minWidth, double minHeight, double maxWidth, double maxHeight) {
    ...
    public Constraints respecting(Constraints other) {
        ...
        return new Constraints(
            class_3532.method_15350(this.minWidth, other.minWidth, other.maxWidth),
            class_3532.method_15350(this.minHeight, other.minHeight, other.maxHeight),
            class_3532.method_15350(this.maxWidth, other.minWidth, other.maxWidth),
            class_3532.method_15350(this.maxHeight, other.minHeight, other.maxHeight)
        );
    }
