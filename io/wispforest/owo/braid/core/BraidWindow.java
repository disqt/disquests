...
public class BraidWindow implements Surface {
    ...
    private class_6367 remoteTarget;
    ...
    public BraidWindow(long handle) {
        ...
        this.remoteTarget = new class_6367("braid window", this.framebufferWidth, this.framebufferHeight, true);
        ...
        GLFW.glfwSetFramebufferSizeCallback(this.handle, this.storeNativeResource(GLFWFramebufferSizeCallback.create((window, width, height) -> {
            ...
            withContext(class_310.method_1551().method_22683().method_4490(), () -> {
                this.remoteTarget.method_1238();
                this.remoteTarget = new class_6367("braid window", this.framebufferWidth, this.framebufferHeight, true);
            });
    ...
    private void recreateLocalFbo() {
        withContext(this.handle, () -> {
            ...
            GL32.glFramebufferTexture2D(GL32.GL_FRAMEBUFFER, GL32.GL_COLOR_ATTACHMENT0, GL32.GL_TEXTURE_2D, ((class_10868) this.remoteTarget.method_30277()).method_68427(), 0);
    ...
    private void recalculateScale() {
        var guiScale = class_310.method_1551().field_1690.method_42474().method_41753();
        var forceUnicodeFont = class_310.method_1551().field_1690.method_42437().method_41753();
    ...
    public static BraidWindow create(String title, int width, int height) {
        ...
        withContext(0, () -> {
            ...
            var handle = GLFW.glfwCreateWindow(width, height, title, 0, class_310.method_1551().method_22683().method_4490());
            ...
            class_1008.method_4227(class_310.method_1551().field_1690.field_1901, true, new HashSet<>());
    ...
    public void beginRendering() {
        RenderSystem.getDevice().createCommandEncoder().clearColorAndDepthTextures(
            this.remoteTarget.method_30277(),
            0xFF000000,
            this.remoteTarget.method_30278(),
            1
        );
    }
