...
public class Color {
    ...
    public static Color hsv(double hue, double saturation, double value, double alpha) {
        ...
        return new Color((int) (alpha * 255) << 24 | class_3532.method_15369((float) (hue - .5e-7f), (float) saturation, (float) value));
    }
    ...
    public static Color formatting(class_124 formatting) {
        var rgb = formatting.method_532();
        return rgb(rgb != null ? rgb : 0);
    }

    public static Color mix(double t, Color a, Color b) {
        return Color.values(
            class_3532.method_16436(t, a.r, b.r),
            class_3532.method_16436(t, a.g, b.g),
            class_3532.method_16436(t, a.b, b.b),
            class_3532.method_16436(t, a.a, b.a)
        );
    }
