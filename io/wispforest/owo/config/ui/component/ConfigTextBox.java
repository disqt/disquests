...
public class ConfigTextBox extends TextBoxComponent implements OptionValueProvider {
    ...
    public ConfigTextBox() {
        ...
        this.textValue.observe(s -> {
            this.method_1868(this.applyPredicate.test(s) ? this.validColor : this.invalidColor);
        });
    }
    ...
    public boolean isValid() {
        return this.applyPredicate.test(this.method_1882());
    }

    @Override
    public Object parsedValue() {
        return this.valueParser.apply(this.method_1882());
    }

    public ConfigTextBox inputPredicate(Predicate<String> inputPredicate) {
        this.inputPredicate = inputPredicate;
        this.method_1890(this.inputPredicate);
        return this;
    }
