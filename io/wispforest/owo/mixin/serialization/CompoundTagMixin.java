...
public abstract class CompoundTagMixin implements MapCarrier {
    ...
    @Shadow
    public abstract @Nullable class_2520 get(String key);
    @Shadow
    public abstract @Nullable class_2520 put(String key, class_2520 element);
    @Shadow
    public abstract @org.jspecify.annotations.Nullable class_2520 remove(String key);
    @Shadow
