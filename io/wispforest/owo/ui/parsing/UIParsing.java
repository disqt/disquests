...
public class UIParsing {
     ...
     * mods, use {@link #registerFactory(class_2960, Function)}, which takes an
     * identifier instead
     */
    @ApiStatus.Internal
     ...
     */
    public static void registerFactory(class_2960 componentId, Function<Element, UIComponent> factory) {
        registerFactory(componentId.method_12836() + "." + componentId.method_12832(), factory);
    }
    ...
    public static class_2561 parseText(Element element) {
        return element.getAttribute("translate").equalsIgnoreCase("true")
                ? class_2561.method_43471(element.getTextContent())
                : class_2561.method_43470(element.getTextContent());
    }
    ...
    static {
        ...
        registerFactory("item", element -> UIComponents.item(class_1799.field_8037));
        registerFactory("block", BlockComponent::parse);

        // Widgets
        registerFactory("label", element -> UIComponents.label(class_2561.method_43473()));
        registerFactory("box", element -> UIComponents.box(Sizing.content(), Sizing.content()));
        registerFactory("button", element -> UIComponents.button(class_2561.method_43473(), (ButtonComponent button) -> {}));
        registerFactory("checkbox", element -> UIComponents.checkbox(class_2561.method_43473()));
