...
public interface UIComponentStub extends UIComponent {
    ...
    @Override
    default UIComponent tooltip(List<class_5684> tooltip) {
        throw new IllegalStateException("Interface stub method called");
    }
    ...
    @Override
    default boolean onMouseUp(class_11909 click) {
        throw new IllegalStateException("Interface stub method called");
    }
    ...
    @Override
    default boolean onMouseDrag(class_11909 click, double deltaX, double deltaY) {
        throw new IllegalStateException("Interface stub method called");
    }
    ...
    @Override
    default boolean onKeyPress(class_11908 input) {
        throw new IllegalStateException("Interface stub method called");
    }
    ...
    @Override
    default boolean onCharTyped(class_11905 input) {
        throw new IllegalStateException("Interface stub method called");
    }
