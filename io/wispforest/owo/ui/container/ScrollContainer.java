...
public class ScrollContainer<C extends UIComponent> extends WrappingParentUIComponent<C> {
    ...
    public static final class_2960 VERTICAL_VANILLA_SCROLLBAR_TEXTURE = Owo.id("scrollbar/vanilla_vertical");
    public static final class_2960 DISABLED_VERTICAL_VANILLA_SCROLLBAR_TEXTURE = Owo.id("scrollbar/vanilla_vertical_disabled");
    public static final class_2960 HORIZONTAL_VANILLA_SCROLLBAR_TEXTURE = Owo.id("scrollbar/vanilla_horizontal_disabled");
    public static final class_2960 DISABLED_HORIZONTAL_VANILLA_SCROLLBAR_TEXTURE = Owo.id("scrollbar/vanilla_horizontal_disabled");
    public static final class_2960 VANILLA_SCROLLBAR_TRACK_TEXTURE = Owo.id("scrollbar/track");
    public static final class_2960 FLAT_VANILLA_SCROLLBAR_TEXTURE = Owo.id("scrollbar/vanilla_flat");
    ...
    public void layout(Size space) {
        ...
        this.scrollOffset = class_3532.method_15350(this.scrollOffset, 0, this.maxScroll + .5);
    ...
    public void draw(OwoUIGraphics graphics, int mouseX, int mouseY, float partialTicks, float delta) {
        ...
        graphics.method_51448().translate((float) this.direction.choose(visualOffset, 0), (float) this.direction.choose(0, visualOffset));
    ...
    public boolean onMouseDown(class_11909 click, boolean doubled) {
        if (this.isInScrollbar(this.x + click.comp_4798(), this.y + click.comp_4799())) {
    ...
    public boolean onMouseDrag(class_11909 click, double deltaX, double deltaY) {
        if (!this.scrollbaring && !this.isInScrollbar(this.x + click.comp_4798(), this.y + click.comp_4799()))
    ...
    public boolean onKeyPress(class_11908 input) {
        if (input.comp_4795() == this.direction.lessKeycode) {
            this.scrollBy(-10, false, true);
        } else if (input.comp_4795() == this.direction.moreKeycode) {
            this.scrollBy(10, false, true);
        } else if (input.comp_4795() == GLFW.GLFW_KEY_PAGE_DOWN) {
        ...
        } else if (input.comp_4795() == GLFW.GLFW_KEY_PAGE_UP) {
            this.scrollBy(this.direction.choose(this.width, this.height) * -.8, false, true);
        }
    ...
    protected void scrollBy(double offset, boolean instant, boolean showScrollbar) {
        this.scrollOffset = class_3532.method_15350(this.scrollOffset + offset, 0, this.maxScroll + .5);
    ...
    public ScrollContainer<C> scrollTo(UIComponent component) {
        if (this.direction == ScrollDirection.VERTICAL) {
            this.scrollOffset = class_3532.method_15350(this.scrollOffset - (this.y - component.y() + component.margins().get().top()), 0, this.maxScroll);
        } else {
            this.scrollOffset = class_3532.method_15350(this.scrollOffset - (this.x - component.x() + component.margins().get().right()), 0, this.maxScroll);
        }
        return this;
    }
    ...
    public interface Scrollbar {
        ...
        static Scrollbar flat(Color color) {
            ...
            return (context, x, y, width, height, trackX, trackY, trackWidth, trackHeight, lastInteractTime, direction, active) -> {
                ...
                final var progress = Easing.SINE.apply(class_3532.method_53062(lastInteractTime - System.currentTimeMillis(), 0, 750) / 750f);
