...
public class CollapsibleContainer extends FlowLayout {
    ...
    public static final Surface SURFACE = (context, component) -> context.method_25294(
            component.x() + 5,
            component.y(),
            component.x() + 6,
    ...
    protected CollapsibleContainer(Sizing horizontalSizing, Sizing verticalSizing, class_2561 title, boolean expanded) {
    ...
    public boolean onMouseDown(class_11909 click, boolean doubled) {
        ...
        if (click.comp_4799() <= this.titleLayout.fullSize().height() && !superResult) {
            this.toggleExpansion();
    ...
    public static CollapsibleContainer parse(Element element) {
        ...
        var title = textElement == null ? class_2561.method_43473() : UIParsing.parseText(textElement);
