...
public abstract class BaseParentUIComponent extends BaseUIComponent implements ParentUIComponent {
    ...
    public boolean onMouseDown(class_11909 click, boolean doubled) {
        if (this.focusHandler != null) {
            this.focusHandler.updateClickFocus(this.x + click.comp_4798(), this.y + click.comp_4799());
        }
    ...
    public boolean onMouseUp(class_11909 click) {
        if (this.focusHandler != null && this.focusHandler.focused() != null) {
            ...
            return focused.onMouseUp(new class_11909(this.x + click.comp_4798() - focused.x(), this.y + click.comp_4799() - focused.y(), click.comp_4800()));
        } else {
    ...
    public boolean onMouseDrag(class_11909 click, double deltaX, double deltaY) {
        if (this.focusHandler != null && this.focusHandler.focused() != null) {
            final var focused = this.focusHandler.focused();
            return focused.onMouseDrag(new class_11909(this.x + click.comp_4798() - focused.x(), this.y + click.comp_4799() - focused.y(), click.comp_4800()), deltaX, deltaY);
        } else {
    ...
    protected Size calculateChildSpace(Size thisSpace) {
        ...
        return Size.of(
            class_3532.method_48781(this.horizontalSizing.get().contentFactor(), this.width - padding.horizontal(), thisSpace.width() - padding.horizontal()),
            class_3532.method_48781(this.verticalSizing.get().contentFactor(), this.height - padding.vertical(), thisSpace.height() - padding.vertical())
        );
    }
