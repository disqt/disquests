...
public record Insets(int top, int bottom, int left, int right) implements Animatable<Insets> {
    ...
    public Insets interpolate(Insets next, float delta) {
        return new Insets(
                (int) class_3532.method_48781(delta, this.top, next.top),
                (int) class_3532.method_48781(delta, this.bottom, next.bottom),
                (int) class_3532.method_48781(delta, this.left, next.left),
                (int) class_3532.method_48781(delta, this.right, next.right)
        );
    }
