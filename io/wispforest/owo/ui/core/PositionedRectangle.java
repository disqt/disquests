...
public interface PositionedRectangle extends Animatable<PositionedRectangle> {
    ...
    default PositionedRectangle interpolate(PositionedRectangle next, float delta) {
        return PositionedRectangle.of(
                (int) class_3532.method_48781(delta, this.x(), next.x()),
                (int) class_3532.method_48781(delta, this.y(), next.y()),
                (int) class_3532.method_48781(delta, this.width(), next.width()),
                (int) class_3532.method_48781(delta, this.height(), next.height())
        );
    }
