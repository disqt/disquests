...
public class TextureComponent extends BaseUIComponent {
    ...
    protected TextureComponent(class_2960 texture, int u, int v, int regionWidth, int regionHeight, int textureWidth, int textureHeight) {
    ...
    public void draw(OwoUIGraphics graphics, int mouseX, int mouseY, float partialTicks, float delta) {
        ...
        graphics.method_25302(this.blend ? class_10799.field_56883 : OwoUIPipelines.GUI_TEXTURED_NO_BLEND,
            this.texture,
            visibleArea.x(),
            visibleArea.y(),
