...
public class ColorPickerComponent extends BaseUIComponent {
    ...
    public void draw(OwoUIGraphics graphics, int mouseX, int mouseY, float partialTicks, float delta) {
        ...
        graphics.field_59826.method_70919(new GradientQuadElementRenderState(
            OwoUIPipelines.GUI_HSV,
            new Matrix3x2f(graphics.method_51448()),
            new class_8030(new class_8029(this.renderX(), this.renderY()), this.colorAreaWidth(), this.renderHeight()),
    ...
    public boolean onMouseDown(class_11909 click, boolean doubled) {
        this.lastClicked = this.showAlpha && click.comp_4798() >= this.alphaSelectorX()
                ? Section.ALPHA_SELECTOR
                : click.comp_4798() > this.hueSelectorX()
                ? Section.HUE_SELECTOR
                : Section.COLOR_AREA;

        this.updateFromMouse(click.comp_4798(), click.comp_4799());
    ...
    protected void updateFromMouse(double mouseX, double mouseY) {
        mouseX = class_3532.method_15350(mouseX - 1, 0, this.renderWidth());
        mouseY = class_3532.method_15350(mouseY - 1, 0, this.renderHeight());
