...
public class LinearProcessExecutor<T> {
     ...
     */
    public void writeState(class_2487 targetTag) {
        targetTag.method_10569("ProcessTick", processTick);
    }
     ...
     */
    public void readState(class_2487 targetTag) {
        this.processTick = targetTag.method_68083("ProcessTick", 0);
