...
public class OwoReiPlugin implements REIClientPlugin {
            ...
            var visitor = new WidgetInstance.Visitor() {
                ...
                public void visit(WidgetInstance<?> child) {
                    if (child instanceof RecipeViewerExclusionZone.Instance area) {
                        ...
                        rectangles.add(new Rectangle(bounds.field_1323, bounds.field_1322, bounds.field_1320 - bounds.field_1323, bounds.field_1325 - bounds.field_1322));
                    }
    ...
    public void registerScreens(ScreenRegistry registry) {
        ...
        registry.registerDraggableStackVisitor(new DraggableStackVisitor<class_437>() {
            @Override
            ...
            @Override
            public Stream<BoundsProvider> getDraggableAcceptingBounds(DraggingContext<class_437> context, DraggableStack stack) {
                ...
                var visitor = new WidgetInstance.Visitor() {
                    ...
                    public void visit(WidgetInstance<?> child) {
                        if (child instanceof StackDropArea.Instance area && area.widget().stackPredicate.test(converted)) {
                            ...
                            allBounds.add(BoundsProvider.ofRectangle(new Rectangle(bounds.field_1323, bounds.field_1322, bounds.field_1320 - bounds.field_1323, bounds.field_1325 - bounds.field_1322)));
                        }
