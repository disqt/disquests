 ...
 * <br>
 * To run this effect, call {@link #spawn(class_1937, class_243, Object)}. If you call this
 ...
 * use {@link Void} as the data class and pass {@code null} to {@link #spawn(class_1937, class_243, Object)}
 *
...
public class ParticleSystem<T> {
     ...
     */
    public void spawn(class_1937 level, class_243 pos, @Nullable T data) {
        ...
        if (level.method_8608()) {
            ...
            manager.sendPacket(this, (class_3218) level, pos, data);
        }
    }

    /**
     * Convenience wrapper for {@link #spawn(class_1937, class_243, Object)}
